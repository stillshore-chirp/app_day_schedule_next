...
| synthetic native E2E | Pass | E2E専用SQLx fixture、単一transactionの性能fixture cleanup、既定window size復元、Compact予定描画完了、200%文字transition完了をassertする最新test sequenceで全3 spec / 15 testがPass |
