...
## Day Schedule Nextの適用範囲

- 製品目的（予定の把握・設計・実行・回復）:
- 影響するsurface（Today / Week / Month / List / timeline / Inspector / Compact / Ticket / Template / Focus / Sync / Data）:
- 影響するstate（empty / loading / offline / conflict / permission / restore / 500件など）:
- 保存精度1分、表示snap、日跨ぎ・DST、local-firstの確認:
- macOS / Windowsのnative・OS依存事項と未確認範囲:
- GitHub共同作業面だけの場合の比例的な確認範囲:
